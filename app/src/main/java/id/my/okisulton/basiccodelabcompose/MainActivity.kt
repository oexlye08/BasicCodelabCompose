package id.my.okisulton.basiccodelabcompose
...
import id.my.okisulton.basiccodelabcompose.ui.theme.BasicCodelabComposeTheme
...
fun MyApp(
    ...
    Surface(modifier) {
        if (shouldShowOnBoarding) {
            OnBoardingScreen(onContinueClicked = { shouldShowOnBoarding = false }, modifier = modifier)
        } else {
